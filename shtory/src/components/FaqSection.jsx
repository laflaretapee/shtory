      ...
      <div className="container faq-layout">
        <div className="faq-main">
          <div className="section-intro section-intro-compact">
            ...
            <p>Коротко отвечаем на то, что спрашивают чаще всего перед заказом.</p>
          </div>
        ...
        <aside className="faq-side-card">
          <h3>Нужен расчёт под ваше окно?</h3>
          <p>Напишите, какие шторы нужны, и мы подскажем, с чего лучше начать.</p>
